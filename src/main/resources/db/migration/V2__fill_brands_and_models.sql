...
VALUES ('A4', (select id from car_brands where name = 'Audi' limit 1)),
...
VALUES ('Ivan', 'Ivanov', 'ivan@mail.ru', '+7921234567', (select id from roles where role = 'admin' limit 1)),
...
VALUES ((select id from car_models where name = 'A4' limit 1),
        (select id from users where email = 'ivan@mail.ru' limit 1), 'A123BC178'),
       ((select id from car_models where name = 'Solaris' limit 1),
        (select id from users where email = 'petr@mail.ru' limit 1), 'X342BH178'),
       ((select id from car_models where name = 'X3' limit 1),
        (select id from users where email = 'ira@mail.ru' limit 1), 'T573TO178'),
       ((select id from car_models where name = 'Q3' limit 1),
        (select id from users where email = 'ira@mail.ru' limit 1), 'O666OO178');