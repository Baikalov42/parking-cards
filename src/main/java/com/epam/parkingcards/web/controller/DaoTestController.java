...
public class DaoTestController {
    ...
    @PutMapping("/brands")
    public CarBrandResponse update(@Valid @RequestBody BrandUpdateRequest brandUpdateRequest,
                                   BindingResult bindingResult) {
        ...
        return carBrandMapper.toCarBrandResponse(
                carBrandService.update(
                        carBrandMapper.toCarBrand(brandUpdateRequest)));
    }
    ...
    @PutMapping("/models")
    public CarModelResponse update(@Valid @RequestBody ModelUpdateRequest modelUpdateRequest,
                                   BindingResult bindingResult) {
        ...
        return carModelMapper.toCarModelResponse(
                carModelService.update(
                        carModelMapper.toCarModel(modelUpdateRequest)));
    }
